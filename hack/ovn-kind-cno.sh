...
FROM quay.io/openshift/origin-ovn-kubernetes:latest
...
# Create Cluster Version resource
kubectl create -f https://raw.githubusercontent.com/openshift/api/master/config/v1/0000_00_cluster-version-operator_01_clusterversion.crd.yaml
...
kubectl create -f https://raw.githubusercontent.com/openshift/api/master/config/v1/0000_10_config-operator_01_infrastructure.crd.yaml

# Create fake cluster version operator resource
...
# Create fake IngressController resource 
kubectl create -f https://github.com/openshift/cluster-ingress-operator/raw/master/manifests/00-custom-resource-definition.yaml
